            ...
            pd.DataFrame(
                {
                    ...
                    "years_to_associates_or_certificate_at_cohort_inst": [pd.NA, pd.NA, pd.NA, 5],
                    "years_to_associates_or_certificate_at_other_inst": [pd.NA, 3, 2, 4],
                    ...
                    "years_of_last_enrollment_at_cohort_institution": [pd.NA, pd.NA, pd.NA, 3],
            ...
            pd.DataFrame(
                {
                    "year_of_enrollment_at_cohort_inst": [1, 2, 3, 4],
                    "cumnum_terms_enrolled": [2, 3, 4, 5],
                    "first_year_to_certificate_at_cohort_inst": [pd.NA, pd.NA, 2, pd.NA],
                    "first_year_to_certificate_at_other_inst": [pd.NA, pd.NA, 2, 2],
                    "years_to_latest_certificate_at_cohort_inst": [pd.NA, pd.NA, 2, pd.NA],
                    "years_to_latest_certificate_at_other_inst": [pd.NA, pd.NA, 3, 3],
