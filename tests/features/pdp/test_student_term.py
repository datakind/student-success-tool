...
from student_success_tool.features.pdp import student_term
            ...
            pd.DataFrame(
                {
                    ...
                    "took_course_course_type_CC|CD": [True, False, True, False],
                    "took_course_course_level_0": [True, False, True, False],
                    "took_course_course_level_2|3": [False, False, True, False],
                    "took_course_grade_0|1|F|W": [True, False, True, False],
                }
            ),
        ),
    ],
