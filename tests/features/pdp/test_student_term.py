            ...
            pd.DataFrame(
                {
                    ...
                    "num_courses_course_type_CC|CD": [True, False, True, False],
                    "num_courses_course_level_0": [True, False, True, False],
                    "num_courses_course_level_2|3": [False, False, True, False],
                    "num_courses_grade_0|1|F|W": [True, False, True, False],
                }
            ),
        ),
    ],
