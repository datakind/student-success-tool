...
from ..utilities import has_access_to_inst_or_err, has_full_data_access_or_err, BaseUser, AccessType
...
def read_inst_user(inst_id: int, user_id: int, current_user: Annotated[BaseUser, Depends()]) -> Any:
