...
def get_all_files(
    inst_id: str,
    datakind_user: bool,
    sst_generated_value: Union[None, bool],
    sess: Session,
) -> list[DataInfo]:
    # construct query
    query = None
