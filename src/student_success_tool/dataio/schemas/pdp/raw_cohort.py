...
class RawPDPCohortDataSchema(pda.DataFrameModel):
    ...
    completed_dev_math_y_1: pt.Series[pd.CategoricalDtype] = pda.Field(nullable=True)
    completed_dev_english_y_1: pt.Series[pd.CategoricalDtype] = pda.Field(nullable=True)
