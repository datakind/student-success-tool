...
from student_success_tool.reporting.model_card.h2o_pdp import PDPModelCard
...
cfg = dataio.read_config("./config-TEMPLATE.toml", schema=h2o_configs.pdp.PDPProjectConfig)
cfg
