...
# %pip install git+https://github.com/datakind/student-success-tool.git@update-inference-output-file --no-deps
# %pip install pandera
...
institution_id = "exuni1"
best_model_run_id = ""  # "TODO"
...
model_type = "sklearn"
labeled_data_path = (
    "sst_dev.exuni1_silver.modeling_dataset"  # "TODO"
)
